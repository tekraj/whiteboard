...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('painting-app/font-awesome/css/fontawesome.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('painting-app/plugins/spectrum/spectrum.css')); ?>">
    <link href="<?php echo e(asset('painting-app/equation-editor/mathquill.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('painting-app/equation-editor/matheditor.css')); ?>" rel="stylesheet">
        ...
        <div class="container-fluid" style="padding:0;">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav top-navbar">
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" href="#">File</a>
                        <ul class="dropdown-menu">
                            <li>
                                <input type="file" class="hidden js-load-whiteboard" data-url="<?php echo e(url("utility/read-sav-file/{$type}")); ?>">
                                <a href="#" class="js-load-whiteboard-click">Load WhiteBoard</a>
                            </li>
                            <li role="separator" class="divider"></li>
                            <li>
                                <a href="#" class="js-save-whiteboard" data-url="<?php echo e(url("utility/save-canvas-to-sav/{$type}")); ?>">Save WhiteBoard As</a>
                            </li>
                            <li role="separator" class="divider"></li>
                            ...
                            <li role="separator" class="divider"></li>
                            <li>
                                <a href="<?php echo e(url($type)); ?>">Exit</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" data-hover="dropdown">Edit</a>
                        <ul  class="dropdown-menu">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" data-hover="dropdown">Tools</a>
                        <ul class="dropdown-menu">
                ...
                <ul class="nav navbar-nav navbar-right prev-next-navbar">
                    ...
                    <li>
                        <button class="btn btn-default btn-sm btn-back " id="canvas-back-state" data-toggle="tooltip" data-placement="bottom" title="Back to previous board"><img src="<?php echo e(asset('painting-app/images/icons/ic_keyboard_arrow_left_black_24dp_1x.png')); ?>"> <span>Back</span></button>
                    </li>
                    <li>
                        <button class="btn btn-default btn-sm btn-next" id="canvas-next-state" data-toggle="tooltip" data-placement="bottom" title="Next Board"><span>Next</span> <img src="<?php echo e(asset('painting-app/images/icons/ic_keyboard_arrow_right_black_24dp_1x.png')); ?>"></button>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
...
<div class="container-fluid top-functions" >
    <div class="row">
        <div class="col-sm-6 top-nav-tools" >
            ...
            <button  class="btn btn-primary btn-square js-tools" data-tool="drag" data-toggle="tooltip" data-placement="top" title="Drag Shapes" data-cursor="url(<?php echo e(asset('painting-app/images/drag.png')); ?>), auto" style="background:url(<?php echo e(asset('painting-app/images/drag.png')); ?>) no-repeat center;width:35px;height:26px;position:relative;">
                &nbsp;
            </button>
            ...
            <!--</a>-->
            <a href="#" class="btn btn-primary btn-square" id="browse-cloud" data-url="<?php echo e(url("{$type}/read-cloud-file")); ?>" data-toggle="tooltip" data-placement="bottom" title="WhiteBoard Cloud">
    ...
    <div class="row">
        <div class="col-md-1 tools-list">
            <div class="text-center my-1 option-menu-wrapper">
                <a href="#" class="btn btn-default js-tools" id="pencil-tool" data-tool="pencil" data-toggle="tooltip" data-placement="top" title="Pencil" data-cursor="url(<?php echo e(asset('painting-app/images/pencil.png')); ?>), auto">
            ...
            <div class="text-center my-1 ">
                <a href="#" class="btn btn-default js-tools" id="enable-text-tool" data-tool="text" data-cursor="url(<?php echo e(asset('painting-app/images/text.png')); ?>), auto" data-toggle="tooltip" data-placement="top" title="Text">
            ...
            <div class="text-center my-1">
                <a href="#" class="btn btn-default js-tools text-center" style="line-height: 30px;" data-tool="line" data-cursor="url(<?php echo e(asset('painting-app/images/line-icon.png')); ?>), auto" data-toggle="tooltip" data-placement="top" title="Draw Line">
                ...
                <ul class="option-menu graph-menu" style="display: none;">
                    <li>
                        <a href="" class="js-tools" data-tool="xgraph" data-cursor="crosshair">
                            <img src="<?php echo e(asset('painting-app/images/graph-x.png')); ?>" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="" class="js-tools" data-tool="xygraph"  data-cursor="crosshair">
                            <img src="<?php echo e(asset('painting-app/images/graph-xy.png')); ?>" alt="">
                        </a>
                    </li>
                </ul>
            ...
            <div class="text-center my-1 option-menu-wrapper">
                ...
                <ul class="option-menu shape-menu" style="display: none">
                    <li>
                        <a href="" class="js-tools" data-tool="line-sarrow" data-cursor="url(<?php echo e(asset('painting-app/images/line-icon.png')); ?>), auto">
                            <img src="<?php echo e(asset('painting-app/images/line-single-arrow.png')); ?>" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="" class="js-tools" data-tool="line-darrow" data-cursor="url(<?php echo e(asset('painting-app/images/line-icon.png')); ?>), auto">
                            <img src="<?php echo e(asset('painting-app/images/line-double-arrow.png')); ?>" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="" class="js-tools" data-tool="rectangle" data-cursor="url(<?php echo e(asset('painting-app/images/line-icon.png')); ?>), auto">
                            <img src="<?php echo e(asset('painting-app/images/square.png')); ?>" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="" class="js-tools" data-tool="rectangle-filled" data-cursor="url(<?php echo e(asset('painting-app/images/line-icon.png')); ?>), auto">
                            <img src="<?php echo e(asset('painting-app/images/square-filled.png')); ?>" alt="">
                        </a>
                    </li>

                    <li>
                        <a href="" class="js-tools" data-tool="oval" data-cursor="crosshair">
                            <img src="<?php echo e(asset('painting-app/images/circle.png')); ?>" alt="">
                        </a>
                    </li>

                    <li>
                        <a href="" class="js-tools" data-tool="oval-filled" data-cursor="crosshair">
                            <img src="<?php echo e(asset('painting-app/images/circle-filled.png')); ?>" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="" class="js-tools" data-tool="cylinder" data-cursor="crosshair">
                            <img src="<?php echo e(asset('painting-app/images/cylinder.png')); ?>" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="" class="js-tools" data-tool="cone" data-cursor="crosshair">
                            <img src="<?php echo e(asset('painting-app/images/cone.png')); ?>" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="" class="js-tools" data-tool="cube" data-cursor="crosshair">
                            <img src="<?php echo e(asset('painting-app/images/cube.png')); ?>" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="" class="js-tools" data-tool="pyramid" data-cursor="crosshair">
                            <img src="<?php echo e(asset('painting-app/images/prism.png')); ?>" alt="">
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="text-center my-1">
                <a href="#" class="btn btn-default btn-square mx-auto js-show-equation-modal">
                    <span data-toggle="tooltip" data-placement="top" title="Click here to open equation editor"> <img src="<?php echo e(asset('painting-app/images/math-w.png')); ?>"></span>
                </a>
            </div>
            ...
            <div class="text-center my-1">
                <a href="#" class="btn btn-default js-tools" id="clear-canvas" data-toggle="modal" data-target="#save-modal">
                    <span class="" data-toggle="tooltip" data-placement="top" title="Click here to clear the board"><img src="<?php echo e(asset('painting-app/images/clear.png')); ?>"></span>
                </a>
            </div>
        ...
        <div class="col-md-11 border px-0 canvas-list">
            ...
            <div class="card chat-card">
                <div class="header">
                    <div class="row ">
                        <div class="col-sm-4">
                            <a  class="nav-link active" id="participants-tab" data-toggle="tab" href="#participants" role="tab"  style="background-color:lightgrey; border:2px solid grey; "aria-controls="home" aria-selected="true"><img src="<?php echo e(asset('painting-app/images/multiple-users-silhouette.png')); ?>"> <b style="color:black;">Participants</b></a>

                        </div>
                        <div class="col-sm-8">
                            <a class="nav-link active" id="participant-tab" data-toggle="tab" href="#chat" role="tab" style="border:2px solidgrey;"aria-controls="home" aria-selected="true"><img src="<?php echo e(asset('painting-app/images/comments.png')); ?>"><b style="color:black;"> Chat</b></a>
                        </div>
                    </div>
                </div>
                <div class="body">
                                    ...
                                    <ul class="input-group-addon list-inline">
                                        <li class="dropdown">
                                            <a herf="#" class=" dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><img
                                                        src="<?php echo e(asset('painting-app/images/icons/ic_tag_faces_black_24dp_1x.png')); ?>" alt=""></a>
                                        ...
                                        <li>
                                            ...
                                            <a href="#" class="js-attach-file" ><img src="<?php echo e(asset('painting-app/images/icons/ic_add_a_photo_black_24dp_1x.png')); ?>" alt=""></a>
                                        </li>
                                    </ul>
                                </div>
                            </form>
...
<div class="modal" id="tech-support-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" class="card" id="send-tech-report" data-url="<?php echo e(url("utility/send-report/{$type}")); ?>">
                <div class="header text-center">
                    <h3 class="margin-0"> Send Tech Support Report</h3>
                </div>
                <div class="body">
                    <?php echo e(Form::textarea('tech_support',null,['class'=>'form-control','id'=>'support-question','style'=>'resize:none;height:100px','required'=>'true'])); ?>

                </div>
                <div class="footer text-center pad-tb-10">
            ...
            <div class="modal-body">
                ...
                <div style="max-height:500px;overflow-y: auto;">
                    <table class="table table-striped table-hover">
                        ...
                        <?php echo $__env->make('utility.session-table',compact('sessions','type'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </tbody>
                    </table>
                </div>
...
<script src="<?php echo e(asset('painting-app/js/bootstrap-dropdownhover.min.js')); ?>"></script>
<script src="<?php echo e(asset('painting-app/plugins/node-waves/waves.js')); ?>"></script>

<script src="<?php echo e(asset('painting-app/equation-editor/mathquill.min.js?ver=1.1')); ?>"></script>
<script src="<?php echo e(asset('painting-app/equation-editor/matheditor.js')); ?>"></script>
<script src="<?php echo e(asset('painting-app/js/dom-to-image.js')); ?>"></script>
<script src="<?php echo e(asset('painting-app/js-tree/jstree.js')); ?>"></script>
<script src="<?php echo e(asset('painting-app/plugins/spectrum/spectrum.js')); ?>"></script>
<script src="<?php echo e(asset('painting-app/nice-scrollbar/jquery.nicescroll.js')); ?>"></script>
<script>
    $("html").niceScroll();
</script>
