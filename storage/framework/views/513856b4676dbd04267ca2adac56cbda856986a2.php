                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <input type="file" class="hidden js-load-whiteboard"
                                       data-url="<?php echo e(url("utility/read-sav-file/{$type}")); ?>">
                    ...
                    <li>
                        <button class="btn btn-default btn-sm btn-back " id="canvas-back-state" data-toggle="tooltip"
                                data-placement="bottom" title="Back to previous board"><img
                                    src="<?php echo e(asset('painting-app/images/icons/ic_keyboard_arrow_left_black_24dp_1x.png')); ?>">
                    ...
                    <li>
                        <button class="btn btn-default btn-sm btn-next" id="canvas-next-state" data-toggle="tooltip"
                                data-placement="bottom" title="Next Board"><span>Next</span> <img
                                    src="<?php echo e(asset('painting-app/images/icons/ic_keyboard_arrow_right_black_24dp_1x.png')); ?>">
                        </button>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
    ...
    <div class="row">
        <div class="col-sm-6 top-nav-tools" style="padding-left:7px;">
            <a href="#" class="btn btn-primary btn-square js-tools"
               data-cursor="url(<?php echo e(asset('painting-app/images/computer-mouse-cursor.png')); ?>), auto" data-tool="select"
               style="background: url(<?php echo e(asset('painting-app/images/computer-mouse-cursor.png')); ?>) no-repeat center;"></a>
            ...
            <a href="#" class="btn btn-primary btn-square" id="reader-mode-indicator" data-toggle="tooltip"
               ...
               style="background: url(<?php echo e(asset('painting-app/images/internet.png')); ?>) no-repeat center;">
            </a>
            ...
            <a href="#" class="btn btn-primary btn-square" id="browse-cloud"
               ...
               style="background:url(<?php echo e(asset('painting-app/images/cloud.png')); ?>) no-repeat center;">
            </a>
            <a href="#session-note-modal" class="btn btn-primary btn-square" title="Session Note" data-toggle="modal"
               style="background:url(<?php echo e(asset('painting-app/images/note.png')); ?>) no-repeat center;"></a>
            <a href="#notification-modal" class="btn btn-primary btn-square" data-toggle="modal" data-placement="bottom"
               title="Notifications"
               style="background: url(<?php echo e(asset('painting-app/images/email.png')); ?>) no-repeat center;">
            </a>
            <a href="#" class="btn btn-primary btn-square" data-toggle="modal" data-target="#print-modal"
               title="Print This drawing"
               style="background: url(<?php echo e(asset('painting-app/images/printer-.png')); ?>) no-repeat center;">
            </a>
            <a href="<?php echo e(url('utility/share-drawing/'.$type)); ?>" class="btn btn-primary btn-square" id="share-drawing"
               data-toggle="tooltip" data-placement="bottom"
               title="Share drawing"
               style="background: url(<?php echo e(asset('painting-app/images/share-connection-sing.png')); ?>) no-repeat center;">
            </a>
            ...
            <a target="_blank"
               ...
               title="Send to mail"
               style="background: url(<?php echo e(asset('painting-app/images/black-back-closed-envelope-shape.png')); ?>) no-repeat center;">
            </a>
        ...
        <div class="col-md-1 tools-list">
            <div class="text-center my-1 option-menu-wrapper">
                <a href="#" class="btn btn-default js-tools" id="pencil-tool" data-tool="pencil" data-toggle="tooltip"
                   ...
                   style="background: url(<?php echo e(asset('painting-app/images/pencil-w.png')); ?>) no-repeat center;">
                </a>
            ...
            <div class="text-center my-1 option-menu-wrapper">
                <a href="#" class="btn btn-default js-tools" data-tool="eraser" data-toggle="tooltip"
                   ...
                   style="background: url(<?php echo e(asset('painting-app/images/eraser-w.png')); ?>) no-repeat center;">
                </a>
            ...
            <div class="text-center my-1 ">
                <a href="#" class="btn btn-default js-tools" id="enable-text-tool" data-tool="text"
                   ...
                   style="background: url(<?php echo e(asset('painting-app/images/text-w.png')); ?>) no-repeat center;">
                </a>
            </div>
            <div class="text-center my-1 font-menu-wrapper  option-menu-wrapper">
                <a href="#" class="btn btn-default btn-square mx-auto js-fonts js-tools"
                   style="background: url(<?php echo e(asset('painting-app/images/1.png')); ?>) no-repeat center;">
                </a>
            ...
            <div class="text-center my-1 option-menu-wrapper">
                <a href="#" style="background:url(<?php echo e(asset('painting-app/images/color-w.png')); ?>) no-repeat center #000;"
            ...
            <div class="text-center my-1">
                <a href="#" id="paste-tool" class="btn btn-default btn-square mx-auto" data-toggle="tooltip"
                   ...
                   style="url(<?php echo e(asset('painting-app/images/paste.png')); ?>) no-repeat center;">
                </a>
            </div>
            <div class="text-center my-1">
                <a href="#" class="btn btn-default js-tools text-center"
                   style="line-height: 30px;background:url(<?php echo e(asset('painting-app/images/line-icon.png')); ?>) no-repeat center;"
                   data-tool="line"
            ...
            <div class="text-center my-1 option-menu-wrapper">
                <a href="#" style="background:url(<?php echo e(asset('painting-app/images/graph-w.png')); ?>) no-repeat center;"
            ...
            <div class="text-center my-1 option-menu-wrapper">
                <a href="#" class="btn btn-default js-tools" data-toggle="tooltip" data-placement="top" title="Shapes"
                   style="background: url(<?php echo e(asset('painting-app/images/shapes-w.png')); ?>) no-repeat center;">
                </a>
                <ul class="option-menu shape-menu" style="display: none">
                    <li>
                        <a href="" class="js-tools" data-tool="line-sarrow"
                           data-cursor="url(<?php echo e(asset('painting-app/images/line-icon.png')); ?>), auto">
            ...
            <div class="text-center my-1">
                <a href="#" class="btn btn-default js-tools" data-toggle="tooltip" data-placement="top" title="Undo"
                   id="undo-tool"
                   style="background: url(<?php echo e(asset('painting-app/images/undo-w.png')); ?>) no-repeat center;">
                </a>
            </div>
            <div class="text-center my-1">
                <a href="#" class="btn btn-default btn-square mx-auto js-show-equation-modal">
                    <span data-toggle="tooltip" data-placement="top" title="Click here to open equation editor"> <img
                                src="<?php echo e(asset('painting-app/images/math-w.png')); ?>"></span>
                </a>
            </div>
            <div class="text-center my-1 science-menu-wrapper  js-enable-symbol">
                <a href="#" class="btn btn-default btn-square mx-auto"
                   style="background: url(<?php echo e(asset('painting-app/images/science-w.png')); ?>) no-repeat center;">
                </a>
            ...
            <div class="text-center my-1">
                <a href="#" class="btn btn-default btn-square mx-auto" id="enable-subscript" data-toggle="tooltip"
                   ...
                   style="background: url(<?php echo e(asset('painting-app/images/asub-w.png')); ?>) no-repeat center;">
                </a>
            ...
            <div class="text-center my-1">
                <a href="#" class="btn btn-default btn-square mx-auto" id="enable-superscript" data-toggle="tooltip"
                   ...
                   style="background: url(<?php echo e(asset('painting-app/images/a2-w.png')); ?>) no-repeat center;">
                </a>
            </div>
                ...
                <a href="#" class="btn btn-default js-tools" id="clear-canvas" data-toggle="modal"
                   data-target="#save-modal">
                    <span class="" data-toggle="tooltip" data-placement="top" title="Click here to clear the board"><img
                                src="<?php echo e(asset('painting-app/images/clear.png')); ?>"></span>
                </a>
            </div>
                        ...
                        <div class="col-sm-4">
                            <a class="nav-link active" id="participants-tab" data-toggle="tab" href="#participants"
                               ...
                               aria-controls="home" aria-selected="true"><img
                                        src="<?php echo e(asset('painting-app/images/multiple-users-silhouette.png')); ?>"> <b
                        ...
                        <div class="col-sm-8">
                            <a class="nav-link active" id="participant-tab" data-toggle="tab" href="#chat" role="tab"
                               style="border:2px solidgrey;" aria-controls="home" aria-selected="true"><img
                                        src="<?php echo e(asset('painting-app/images/comments.png')); ?>"><b style="color:black;">
                                    Chat</b></a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <ul class="input-group-addon list-inline">
                                        <li class="dropdown">
                                            <a herf="#" class=" dropdown-toggle" data-toggle="dropdown" role="button"
                                               aria-expanded="false"><img
                                                        src="<?php echo e(asset('painting-app/images/icons/ic_tag_faces_black_24dp_1x.png')); ?>"
                                                        alt=""></a>
                                        ...
                                        <li>
                                            ...
                                            <a href="#" class="js-attach-file"><img
                                                        src="<?php echo e(asset('painting-app/images/icons/ic_add_a_photo_black_24dp_1x.png')); ?>"
                                                        alt=""></a>
                                        </li>
                                    </ul>
                                </div>
...
<div class="modal" id="tech-support-modal">
    <div class="modal-dialog">
        <form method="post" id="send-tech-report" data-url="<?php echo e(url("utility/send-report/{$type}")); ?>">
    ...
    <div class="modal-dialog" style="width:60%;">
        <div class="modal-content" style="width:100%;">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" value="<?php echo e($subject->id); ?>" name="subject_id">
                <div class="row">
                    <div class="col-sm-8">
                        <div class="input-group">
                            ...
                            <input name="daterange" type="text" class="form-control js-daterangepicker"
                                   aria-describedby="end-date-label" value="<?php echo e(date('m/d/Y')); ?>"
...
<script src="<?php echo e(asset('painting-app/LaTeX/latex.js')); ?>"></script>
<script>
    $.ajaxSetup({
        headers: {
