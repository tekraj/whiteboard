                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            Hi <span class="text-primary"><?php echo e($user->name); ?></span>,  To share your document drop file or upload
                        </div>
                        <div class="card-body text-center">
                            ...
                            <input type="file" name="sharedrawing" style="display: none;" id="share-file" multiple="true" data-url="<?php echo e(url("utility/share-files/{$type}?user={$sharedUser->id}&userType={$sharedUserType}")); ?>">
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <table class="table table-striped">
                                ...
                                <tbody id="shared-doc">
                                    <?php $__currentLoopData = $documentShared; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><a href="<?php echo e(url("storage/shared_docs-{$doc->image}")); ?>"><?php echo e($doc->image); ?></a></td>
                                            <td><?php echo e($doc->shared_to); ?></td>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-striped">
                                ...
                                <tbody >
                                <?php $__currentLoopData = $receivedDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><a href="<?php echo e(url("storage/shared_docs-{$doc->image}")); ?>"><?php echo e($doc->image); ?></a></td>
                                        <td><?php echo e($doc->shared_by); ?></td>
                                        <td><?php echo e($doc->created_at); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
