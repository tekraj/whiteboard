        ...
        <nav class="navbar-mobile">
            <div class="container-fluid">
                <ul class="navbar-mobile__list list-unstyled">
                    <li>
                        <a class="js-arrow" href="<?php echo e(url('tutor/dashboard')); ?>"><i class="fas fa-tachometer-alt"></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="chart.html">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span style="font-size:24px;font-weight: bold" class="text-danger" id="month-holder" data-month="<?php echo e((int) \Carbon\Carbon::now()->format('m')); ?>">
                                ...
                                <div class="col-sm-6 text-right">
                                    <div class="btn-group">
                                        <button class="btn btn-primary js-prev-next-month" id="prev-month" data-factor="-1" data-url="<?php echo e(url('tutor/dashboard/get-calender')); ?>">Prev Month</button>
                                        &nbsp;
                                        <button class="btn btn-primary js-prev-next-month" id="next-month" data-factor="1" data-url="<?php echo e(url('tutor/dashboard/get-calender')); ?>">Next Month</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-body" id="calender-holder">
                            ...
                            ?>
                            <?php echo $__env->make('tutor.calender',compact('endOfTheMonth','url','month','allSchedules'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                    </div>
