function MathEditor(id){
    ...
    button_meta = {
        ...
        "neg": {latex: "\\neg", tab: 1, icon:'\\neg'},
        "equiv": {latex: "\\equiv", tab: 1, icon:'\\equiv'},
        "vee": {latex: "\\vee", tab: 1, icon:'\\vee'},
        "less_equal": {latex: "\\leq", tab: 1, icon:'\\leq'},
        "greater_equal": {latex: "\\geq", tab: 1, icon:'\\geq'},
        "ll": {latex: "\\ll", tab: 1, icon:'\\ll'},
        "gg": {latex: "\\gg", tab: 1, icon:'\\gg'},
        "sim": {latex: "\\sim", tab: 1, icon:'\\sim'},
        "approx": {latex: "\\approx", tab: 1, icon:'\\approx'},
        "simeq": {latex: "\\simeq", tab: 1, icon:'\\simeq'},
        "cong": {latex: "\\cong", tab: 1, icon:'\\cong'},
        "propto": {latex: "\\propto", tab: 1, icon:'\\propto'},
        "forall": {latex: "\\forall", tab: 1, icon:'\\forall'},
        "exists": {latex: "\\exists", tab: 1, icon:'\\exists'},
        "prec": {latex: "\\prec", tab: 1, icon:'\\prec'},
        "parallel": {latex: "\\parallel", tab: 1, icon:'\\parallel'},
        "subset": {latex: "\\subset", tab: 1, icon:'\\subset'},
        "supset": {latex: "\\supset", tab: 1, icon:'\\supset'},
        "subseteq": {latex: "\\subseteq", tab: 1, icon:'\\subseteq'},
        "cap": {latex: "\\cap", tab: 1, icon:'\\cap'},
        "cup": {latex: "\\cup", tab: 1, icon:'\\cup'},
        "in": {latex: "\\in", tab: 1, icon:'\\in'},
        "emptyset": {latex: "\\emptyset", tab: 1, icon:'\\emptyset'},
        "plus_minus": {latex: "\\pm", tab: 1, icon:'\\pm'},
        "prime": {latex: "\\prime", tab: 1, icon:'\\prime'},
        "circle": {latex: "\\circ", tab: 1, icon:'\\circ'},
        "leftarrow": {latex: "\\leftarrow", tab: 1, icon:'\\leftarrow'},
        "rightarrow": {latex: "\\rightarrow", tab: 1, icon:'\\rightarrow'},
        "leftrightarrow": {latex: "\\leftrightarrow", tab: 1, icon:'\\leftrightarrow'},
        "notrightarrow": {latex: "\\not\\rightarrow", tab: 1, icon:'\\not\\rightarrow'},
        "notleftrightarrow": {latex: "\\not\\leftrightarrow", tab: 1, icon:'\\not\\leftrightarrow'},
        "infty": {latex: "\\infty", tab: 1, icon:'\\infty'},
        "nabla": {latex: "\\nabla", tab: 1, icon:'\\nabla'},
        "hbar": {latex: "\\hbar", tab: 1, icon:'\\hbar'},
        "ddagger": {latex: "\\ddagger", tab: 1, icon:'\\ddagger'},
        "otimes": {latex: "\\otimes", tab: 1, icon:'\\otimes'},
        "degree": {latex: "\\degree", tab: 1, icon:'\\degree'},
        "angle": {latex: "\\angle", tab: 1, icon:'\\angle'},

        // tab 2
        "subscript": {latex: "\\_{}", moveto: "Down", movefor: 1, tab: 2, icon:'\\square_{2}'},
        "superscript": {latex: "\\^{}", moveto: "Up", movefor: 1, tab: 2, icon:'\\square^2'},
        "fraction": {latex: "\\frac{}{}", moveto: "Up", movefor: 1, tab: 2, icon:'\\frac{\\square}{\\square}'},
        "square_root": {latex: "\\sqrt{}", moveto: "Left", movefor: 1, tab: 2, icon:'\\sqrt{\\square}'},
        "cube_root": {latex: "\\sqrt[3]{}", moveto: "Left", movefor: 1, tab: 2, icon:'\\sqrt[3]{\\square}'},
        "root": {latex: "\\sqrt[{}]{}", moveto: "Left", movefor: 2, tab: 2, icon:'\\sqrt[\\square]{\\square}'},
        "sum": {latex: "\\sum_{i=1}^{n}", moveto: "Left", movefor: 3, tab: 2, icon:'\\sum_{i=1}^n'},
        "prod": {latex: "\\prod_{i}^{n}", moveto: "Left", movefor:3 , tab: 2, icon:'\\prod_{i}^{n}'},
        "integral": {latex: "\\int\\f({x})", moveto: "Left", movefor:1 , tab: 2, icon:'\\int\\f({x})'},
        "integrallu": {latex: "\\int_{a}^{b}f({x})", moveto: "Left", movefor:7 , tab: 2, icon:'\\int_{a}^{b}f({x})'},
        "limit": {latex: "lim_{a}_\\rightarrow_{b}", moveto: "Left", movefor: 1, tab: 2, icon:'lim_{a}_\\rightarrow_{b}'},
        "function": {latex: "f({x})", moveto: "Left", movefor: 1, tab: 2, icon:'f({x})'},
        "ln": {latex: "\\ln",  tab: 2, icon:'\\ln'},
        "logn": {latex: "\\log_{x}", moveto: "Left", movefor: 1, tab: 2, icon:'\\log_{x}'},
        "e": {latex: "e^{x}", moveto: "Left", movefor: 1, tab: 2, icon:'e^{x}'},

        //tab3
        "sin" : {latex: "sin({x})", moveto: "Left", movefor: 1, tab: 3, icon:'sin({x})'},
        "arcsin" :  {latex: "arcsin({x})", moveto: "Left", movefor: 1, tab: 3, icon:'arcsin({x})'},
        "sinh" :  {latex: "sinh({x})", moveto: "Left", movefor: 1, tab: 3, icon:'sinh({x})'},
        "cos" :  {latex: "cos({x})", moveto: "Left", movefor: 1, tab: 3, icon:'cos({x})'},
        "arccos" :  {latex: "arccos({x})", moveto: "Left", movefor: 1, tab: 3, icon:'arccos({x})'},
        "cosh" :  {latex: "cosh({x})", moveto: "Left", movefor: 1, tab: 3, icon:'cosh({x})'},
        "tan" :  {latex: "tan({x})", moveto: "Left", movefor: 1, tab: 3, icon:'tan({x})'},
        "arctan" :  {latex: "arctan({x})", moveto: "Left", movefor: 1, tab: 3, icon:'arctan({x})'},
        "tanh" :  {latex: "tanh({x})", moveto: "Left", movefor: 1, tab: 3, icon:'tanh({x})'},
        "csc" :  {latex: "csc({x})", moveto: "Left", movefor: 1, tab: 3, icon:'csc({x})'},
        "arccsc" :  {latex: "arccsc({x})", moveto: "Left", movefor: 1, tab: 3, icon:'arccsc({x})'},
        "csch" :  {latex: "csch({x})", moveto: "Left", movefor: 1, tab: 3, icon:'csch({x})'},
        "sec" :  {latex: "sec({x})", moveto: "Left", movefor: 1, tab: 3, icon:'sec({x})'},
        "arcsec" :  {latex: "arcsec({x})", moveto: "Left", movefor: 1, tab: 3, icon:'arcsec({x})'},
        "sech" :  {latex: "sech({x})", moveto: "Left", movefor: 1, tab: 3, icon:'sech({x})'},
        "cot" :  {latex: "cot({x})", moveto: "Left", movefor: 1, tab: 3, icon:'cot({x})'},
        "arccot" :  {latex: "arccot({x})", moveto: "Left", movefor: 1, tab: 3, icon:'arccot({x})'},
        "coth" :  {latex: "coth({x})", moveto: "Left", movefor: 1, tab: 3, icon:'coth({x})'},

        //tab 4
        "corrcoef" : {latex: "corrcoef({x})", moveto: "Left", movefor: 1, tab: 4, icon:'corrcoef'},
        "cov" : {latex: "cov({x})", moveto: "Left", movefor: 1, tab: 4, icon:'cov'},
        "median" : {latex: "median({x})", moveto: "Left", movefor: 1, tab: 4, icon:'median'},
        "std" : {latex: "std({x})", moveto: "Left", movefor: 1, tab: 4, icon:'std'},
        "mod" : {latex: "mod({x})", moveto: "Left", movefor: 1, tab: 4, icon:'mod'},
        "floor" : {latex: "floor({x})", moveto: "Left", movefor: 1, tab: 4, icon:'floor'},
        "ceil" : {latex: "ceil({x})", moveto: "Left", movefor: 1, tab: 4, icon:'ceil'},
        "sign" : {latex: "sign({x})", moveto: "Left", movefor: 1, tab: 4, icon:'sign'},
        "gcd" : {latex: "gcd({x})", moveto: "Left", movefor: 1, tab: 4, icon:'gcd'},
        "lcm" : {latex: "lcm({x})", moveto: "Left", movefor: 1, tab: 4, icon:'lcm'},
        "random" : {latex: "random({x})", moveto: "Left", movefor: 1, tab: 4, icon:'random'},
        "eye" : {latex: "eye({x})", moveto: "Left", movefor: 1, tab: 4, icon:'eye'},
        "transpose" : {latex: "transpose({x})", moveto: "Left", movefor: 1, tab: 4, icon:'transpose'},
        "inverse" : {latex: "inverse({x})", moveto: "Left", movefor: 1, tab: 4, icon:'inverse'},
        "det" : {latex: "det({x})", moveto: "Left", movefor: 1, tab: 4, icon:'det'},
        "min" : {latex: "min({x})", moveto: "Left", movefor: 1, tab: 4, icon:'min'},
        "max" : {latex: "max({x})", moveto: "Left", movefor: 1, tab: 4, icon:'max'},
        "rows" : {latex: "rows({x})", moveto: "Left", movefor: 1, tab: 4, icon:'rows'},
        "columns" : {latex: "columns({x})", moveto: "Left", movefor: 1, tab: 4, icon:'columns'},
        "plot" : {latex: "plot({x})", moveto: "Left", movefor: 1, tab: 4, icon:'plot'},
        "meshgrid" : {latex: "meshgrid({x})", moveto: "Left", movefor: 1, tab: 4, icon:'meshgrid'},
        "mesh" : {latex: "mesh({x})", moveto: "Left", movefor: 1, tab: 4, icon:'mesh'},

        //tab5

        "alpha":{latex: "\\alpha",  tab: 5, icon:'\\alpha'},
        "beta":{latex: "\\beta",  tab: 5, icon:'\\beta'},
        "gamma":{latex: "\\gamma",  tab: 5, icon:'\\gamma'},
        "delta":{latex: "\\gamma",  tab: 5, icon:'\\gamma'},
        "epsilon":{latex: "\\epsilon",  tab: 5, icon:'\\epsilon'},
        "varepsilon":{latex: "\\varepsilon",  tab: 5, icon:'\\varepsilon'},
        "zeta":{latex: "\\zeta",  tab: 5, icon:'\\zeta'},
        "eta":{latex: "\\eta",  tab: 5, icon:'\\eta'},
        "theta":{latex: "\\theta",  tab: 5, icon:'\\theta'},
        "vartheta":{latex: "\\vartheta",  tab: 5, icon:'\\vartheta'},
        "iota":{latex: "\\iota",  tab: 5, icon:'\\iota'},
        "kappa":{latex: "\\kappa",  tab: 5, icon:'\\kappa'},
        "lambda":{latex: "\\lambda",  tab: 5, icon:'\\lambda'},
        "mu":{latex: "\\mu",  tab: 5, icon:'\\mu'},
        "nu":{latex: "\\nu",  tab: 5, icon:'\\nu'},
        "xi":{latex: "\\xi",  tab: 5, icon:'\\xi'},
        //"omicron":{latex: "\\omicron",  tab: 5, icon:'\\omicron'},
        "pi":{latex: "\\pi",  tab: 5, icon:'\\pi'},
        "varpi":{latex: "\\varpi",  tab: 5, icon:'\\varpi'},
        "rho":{latex: "\\rho",  tab: 5, icon:'\\rho'},
        "varrho":{latex: "\\varrho",  tab: 5, icon:'\\varrho'},
        "sigma":{latex: "\\sigma",  tab: 5, icon:'\\sigma'},
        "varsigma":{latex: "\\varsigma",  tab: 5, icon:'\\varsigma'},
        "tau":{latex: "\\tau",  tab: 5, icon:'\\tau'},
        "upsilon":{latex: "\\upsilon",  tab: 5, icon:'\\upsilon'},
        "phi":{latex: "\\phi",  tab: 5, icon:'\\phi'},
        "varphi":{latex: "\\varphi",  tab: 5, icon:'\\varphi'},
        "chi":{latex: "\\chi",  tab: 5, icon:'\\chi'},
        "psi":{latex: "\\psi",  tab: 5, icon:'\\psi'},
        "omega":{latex: "\\omega",  tab: 5, icon:'\\omega'},
        "Gamma":{latex: "\\Gamma",  tab: 5, icon:'\\Gamma'},
        "Delta":{latex: "\\Delta",  tab: 5, icon:'\\Delta'},
        "Theta":{latex: "\\Theta",  tab: 5, icon:'\\Theta'},
        "Lambda":{latex: "\\Lambda",  tab: 5, icon:'\\Lambda'},
        "Xi":{latex: "\\Xi",  tab: 5, icon:'\\Xi'},
        "Pi":{latex: "\\Pi",  tab: 5, icon:'\\Pi'},
        "Sigma":{latex: "\\Sigma",  tab: 5, icon:'\\Sigma'},
