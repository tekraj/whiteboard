        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            {{ Form::label('password', ($student->id>0 ? 'Password' : 'Password*'), ['class' => 'col-sm-3 text-right','style'=>'margin-top:8px']) }}
                            <div class="col-sm-9">
                                {{ Form::password('password', ['class' => 'form-control',($student->id>0 ? '':'required')=>true,'autocomplete'=>str_random(7)]) }}
                            </div>
                        </div>
                    </div>
                </div>
