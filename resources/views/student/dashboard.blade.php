            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-right">
                                <div class="btn-group">
                                    <button class="btn btn-primary js-prev-next-month" id="prev-month" data-factor="-1" data-url="{{url('student/dashboard/get-calender')}}">Prev Month</button>
                                    &nbsp;
                                    <button class="btn btn-primary js-prev-next-month" id="next-month" data-factor="1" data-url="{{url('student/dashboard/get-calender')}}">Next Month</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body" id="calender-holder">
                        ...
                        ?>
                        @include('student.calender',compact('endOfTheMonth','url','month','allSchedules'))
                    </div>
                </div>
    ...
    <div class="modal" id="whiteboard-process-modal">
        <div class="modal-dialog" style="width:400px;">
            <div class="modal-content">
                {{Form::open(['url'=>url('student/process-whiteboard-request'),'method'=>'get','class'=>'card','style'=>'margin-bottom:0'])}}
                <div class="card-header text-center">
                    Please Select Subject
                </div>

                <div class="card-body">
                    {{Form::select('subject_id',[''=>'Select Subject']+$subjects,null,['class'=>'form-control','required'=>'true'])}}
                </div>
